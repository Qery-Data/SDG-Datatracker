...
#15_9
url = "https://api.datawrapper.de/v3/charts?folderId=119580&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_15_9 = []
for i in json_object['list']:
        chart_list_15_9.append(i['publicId'])
...
#Publish
chart_list_15_all = (chart_list_15_1 + chart_list_15_2 + chart_list_15_4 + chart_list_15_5 + chart_list_15_6 + chart_list_15_9 + chart_list_15_a)
...
#16_1
url = "https://api.datawrapper.de/v3/charts?folderId=119791&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_1 = []
for i in json_object['list']:
        chart_list_16_1.append(i['publicId'])

#16_3
url = "https://api.datawrapper.de/v3/charts?folderId=120088&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_3 = []
for i in json_object['list']:
        chart_list_16_3.append(i['publicId'])

#16_5
url = "https://api.datawrapper.de/v3/charts?folderId=120138&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_5 = []
for i in json_object['list']:
        chart_list_16_5.append(i['publicId'])

#16_6
url = "https://api.datawrapper.de/v3/charts?folderId=120140&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_6 = []
for i in json_object['list']:
        chart_list_16_6.append(i['publicId'])
...
chart_list_16_7 = []
for i in json_object['list']:
        chart_list_16_7.append(i['publicId'])

#16_8
url = "https://api.datawrapper.de/v3/charts?folderId=120147&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_8 = []
for i in json_object['list']:
        chart_list_16_8.append(i['publicId'])

#16_9
url = "https://api.datawrapper.de/v3/charts?folderId=120148&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_9 = []
for i in json_object['list']:
        chart_list_16_9.append(i['publicId'])

#16_10
url = "https://api.datawrapper.de/v3/charts?folderId=120149&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_10 = []
for i in json_object['list']:
        chart_list_16_10.append(i['publicId'])

#16_a
url = "https://api.datawrapper.de/v3/charts?folderId=120156&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_16_a = []
for i in json_object['list']:
        chart_list_16_a.append(i['publicId'])

#Publish
chart_list_16_all = (chart_list_16_1 + chart_list_16_3 + chart_list_16_5 + chart_list_16_6 + chart_list_16_7 + chart_list_16_8 + chart_list_16_9 + chart_list_16_10 + chart_list_16_a)
for vars in chart_list_16_all:
    url = "https://api.datawrapper.de/v3/charts/" + vars + '/publish/'
    headers = {
        "Authorization": ("Bearer " + access_token),
        "Accept": "*/*"
...
#17_1
url = "https://api.datawrapper.de/v3/charts?folderId=120198&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_1 = []
for i in json_object['list']:
        chart_list_17_1.append(i['publicId'])

#17_2
url = "https://api.datawrapper.de/v3/charts?folderId=120267&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_2 = []
for i in json_object['list']:
        chart_list_17_2.append(i['publicId'])

#17_3
url = "https://api.datawrapper.de/v3/charts?folderId=120316&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_3 = []
for i in json_object['list']:
        chart_list_17_3.append(i['publicId'])

#17_4
url = "https://api.datawrapper.de/v3/charts?folderId=120317&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_4 = []
for i in json_object['list']:
        chart_list_17_4.append(i['publicId'])

#17_5
url = "https://api.datawrapper.de/v3/charts?folderId=120318&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_5 = []
for i in json_object['list']:
        chart_list_17_5.append(i['publicId'])

#17_7
url = "https://api.datawrapper.de/v3/charts?folderId=120319&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_7 = []
for i in json_object['list']:
        chart_list_17_7.append(i['publicId'])

#17_8
url = "https://api.datawrapper.de/v3/charts?folderId=120320&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_8 = []
for i in json_object['list']:
        chart_list_17_8.append(i['publicId'])

#17_9
url = "https://api.datawrapper.de/v3/charts?folderId=120321&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_9 = []
for i in json_object['list']:
        chart_list_17_9.append(i['publicId'])

#17_10
url = "https://api.datawrapper.de/v3/charts?folderId=120322&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_10 = []
for i in json_object['list']:
        chart_list_17_10.append(i['publicId'])

#17_11
url = "https://api.datawrapper.de/v3/charts?folderId=120325&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_11 = []
for i in json_object['list']:
        chart_list_17_11.append(i['publicId'])

#17_12
url = "https://api.datawrapper.de/v3/charts?folderId=120326&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_12 = []
for i in json_object['list']:
        chart_list_17_12.append(i['publicId'])

#17_15
url = "https://api.datawrapper.de/v3/charts?folderId=120327&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_15 = []
for i in json_object['list']:
        chart_list_17_15.append(i['publicId'])

#17_19
url = "https://api.datawrapper.de/v3/charts?folderId=120328&order=DESC&orderBy=createdAt&limit=100&offset=0&expand=false"
headers = {
    "Authorization": ("Bearer " + access_token),
    "Accept": "*/*"
    }
...
chart_list_17_19 = []
for i in json_object['list']:
        chart_list_17_19.append(i['publicId'])

#Publish
chart_list_17_all = (chart_list_17_1 + chart_list_17_2 + chart_list_17_3 + chart_list_17_4 + chart_list_17_5 + chart_list_17_7 + chart_list_17_8 + chart_list_17_9 + chart_list_17_10 + chart_list_17_11 + chart_list_17_12 + chart_list_17_15 + chart_list_17_19)
for vars in chart_list_17_all:
    url = "https://api.datawrapper.de/v3/charts/" + vars + '/publish/'
    headers = {
        "Authorization": ("Bearer " + access_token),
        "Accept": "*/*"
