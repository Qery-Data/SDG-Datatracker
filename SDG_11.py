...
df_csv = pd.read_csv('https://data.un.org/ws/rest/data/IAEG-SDGs,DF_SDG_GLH,1.14/..EN_LND_SLUM.1.........../ALL/?detail=full&dimensionAtObservation=TIME_PERIOD&format=csv')
...
df_csv = pd.read_csv('https://data.un.org/ws/rest/data/IAEG-SDGs,DF_SDG_GLH,1.14/..EN_LND_SLUM.9+62+513+53+747+753+202+419.........../ALL/?detail=full&startPeriod=2000-01-01&dimensionAtObservation=TIME_PERIOD&format=csv')
...
#df_csv = pd.read_csv('https://data.un.org/ws/rest/data/IAEG-SDGs,DF_SDG_GLH,1.14/..SP_TRN_PUBL.1+9+62+513+53+747+753+202+419......._T..../ALL/?detail=full&dimensionAtObservation=TIME_PERIOD&format=csv')
#df_new = df_csv.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
...
#11.6.2 Mean annual concentration of PM2.5 SDG regions (inlDz)
df_csv = pd.read_csv('https://data.un.org/ws/rest/data/IAEG-SDGs,DF_SDG_GLH,1.14/..EN_ATM_PM25.1+53+62+513+543+747+753+202+419...U......../ALL/?detail=full&dimensionAtObservation=TIME_PERIOD&format=csv')
df_new = df_csv.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
...
df_new.to_csv('data/11_6_2_Mean_Annual_Concentration_PM25_SDG_Regions.csv', index=True)
...
#11.7.1 Open public space World and SDG regions (LxytD)
#df_csv = pd.read_csv('https://data.un.org/ws/rest/data/IAEG-SDGs,DF_SDG_GLH,1.14/..EN_URB_OPENSP.1+53+62+513+543+747+753+202+419.........../ALL/?detail=full&dimensionAtObservation=TIME_PERIOD&format=csv')
#df_new = df_csv.pivot(index='REF_AREA', columns='TIME_PERIOD', values='OBS_VALUE')
#df_new.rename(index={1: 'World', 53: 'Australia and New Zealand', 62: 'Central and Southern Asia', 202: 'Sub-Saharan Africa', 419: 'Latin America and the Caribbean', 513: 'Europe and Northern America',543: 'Oceania*', 747: 'Northern Africa and Western Asia', 753: 'Eastern and South-Eastern Asia'}, inplace=True)
#df_new.to_csv('data/11_7_1_Share_Cities_Open_Space_World_SDG_Regions.csv', index=True)

#11.a.1 National urban policies or regional development plans Nordics (xxxxx)
df_csv = pd.read_csv('https://data.un.org/ws/rest/data/IAEG-SDGs,DF_SDG_GLH,1.14/..SD_CPA_UPRDP.208+246+352+578+752.........../ALL/?detail=full&dimensionAtObservation=TIME_PERIOD&format=csv')
df_new = df_csv.pivot(index='TIME_PERIOD', columns='REF_AREA', values='OBS_VALUE')
df_new.rename(columns={208: 'Denmark', 246: 'Finland', 352: 'Iceland', 578:'Norway',752:'Sweden'},inplace=True)
df_new.to_csv('data/11_a_1_National_Urban_Policies_Regional_Dev_Plans_Nordisc.csv', index=True)